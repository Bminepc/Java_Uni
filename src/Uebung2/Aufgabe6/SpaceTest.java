...
public class SpaceTest {
    ...
    public static void main(String[] args) {
        ...
        Kleinkörper[] kleinkörper = new Kleinkörper[3];
        kleinkörper[0] = new Komet("Seltsamer1", 1, 1.0, sonne, 34.0);
        kleinkörper[1] = new Komet("Seltsamer2", 2, 2.0, sonne, 34.0);
        kleinkörper[2] = new Asteroid("Asto", 30, 120000.0, sonne, true);
    }
}
